...
//Code Here
let totalPopulation = populations.reduce((a,e) => a + e,0)
...
let ordersTotal = orders.map(e => e.price + (e.tax * e.price))
...
let bobsTotal = purchases.filter(e => e.owner === 'Bob').map(e => e.price).reduce((a,e) => a + e, 0)
